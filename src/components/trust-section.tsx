    ...
    <section className="bg-background py-20 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="lg:w-[90%]">
          ...
          <h2 className="text-4xl sm:text-3xl xs:text-2xl font text-headline mb-8 leading-relaxed">
          ...
          <a
            href="#"
            className="text-link font-semibold text-sm sm:text-base inline-flex items-center hover:underline focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 rounded transition-all"
          >
